"""
WSI-Precision Stage 3: Score Aggregation
This script calculates average scores from claim-based evaluation results.
"""
...
def process_evaluation_file(eval_file_path):
    ...
    output_file = eval_file_path.replace("evaluation_results", "aggregated_scores")
...
def process_folder(folder_path, pattern="evaluation_results"):
    """
    Process all evaluation files in a folder.
    
    Args:
        folder_path: Path to folder containing evaluation files
        pattern: Filename pattern to match (default: "evaluation_results")
    """
