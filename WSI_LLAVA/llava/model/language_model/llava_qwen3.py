...
class LlavaQwen3Config(_QwenConfig):
    model_type = "llava_qwen3"


class LlavaQwen3Model(LlavaMetaModel, _QwenModel):
...
class LlavaQwen3ForCausalLM(_QwenForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaQwen3Config

    def __init__(self, config):
        super(_QwenForCausalLM, self).__init__(config)
